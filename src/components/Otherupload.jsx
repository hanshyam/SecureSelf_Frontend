...
function Otherupload() {
  ...
  return (
    <div
      className="w-full min-h-[100vh] bg-red-500 py-[10%]"
      ...
      <div className="max-w-lg mx-auto p-6 bg-[#ffffff] border border-red-400 shadow-md rounded-lg">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label
              htmlFor="category"
              className="block text-[#1d3a55] text-lg font-medium mb-2"
            >
              Select Category
            </label>
            <select
          ...
          {imageUrl && (
            <div className="text-center mb-6">
              <img
                src={imageUrl}
                alt="Uploaded"
                className="mx-auto w-32 h-32 object-cover rounded-lg shadow-md mb-2"
              />
            </div>
          )}
